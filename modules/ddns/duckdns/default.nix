    ...
    assertions = [
      {
        ...
        message = "Either ddns.duckdns.domains or ddns.duckdns.domainsFile has to be defined";
      }
      {
        assertion = !(cfg.domains != null && cfg.domainsFile != null);
        message = "ddns.duckdns.domains and ddns.duckdns.domainsFile can't both be defined at the same time";
      }
      {
        assertion = cfg.tokenFile != null;
        message = "ddns.duckdns.tokenFile has to be defined";
      }
    ];
